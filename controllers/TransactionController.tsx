...
// Presenter (controller logic) for transaction data: filtering, sorting, grouping
...
export function filterAndGroupTransactions(
  ...
  // Step 2: Sort transactions by date (descending, newest first)
  ...
  // Step 3: Group transactions by formatted date label
